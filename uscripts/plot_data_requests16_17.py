...
# -*- coding: utf-8 -*-
"""
Created on Mon Jan 19 09:24:03 2026
...
data_pos = np.load('../data/jica_datarequest_nr16.npz')
...
data_neg = np.load('../data/jica_datarequest_nr17.npz')
...
for i in range(len(time_pos)):
    en_table_reduced_pos = en_table[228:242]
    ...
    en_table_reduced_neg = en_table[350:380]
    ...
    sp.ax[0].plot(en_table, reduced_data_pos[:, i])
    ...
    sp.ax[1].plot(en_table, reduced_data_neg[:, i])
