...
# -*- coding: utf-8 -*-
"""
Created on Wed Jan 14 14:23:53 2026
...
positive_masses_major_only = np.array([1.008, 2.016, 3.024, 4.003, 25.312, 24.304])
...
def energy_to_mass_positive(E, U, v, q=1):
        return 2*q*e*(E + U)/(mp * v**2)
mass = energy_to_mass_positive(en_table, U = U_prel, v = v_prel)
...
for i in positive_masses:
    sp.ax.axvline(i, color ='k', linestyle = 'dotted')
sp.ax.plot(mass, reduced_data[:, 0])
sp.ax.axvline(60.03, color = 'red', linestyle = 'dotted')
sp.ax.set_ylim([1, None])
plt.show()
